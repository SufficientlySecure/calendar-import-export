...
When enabled, more information will be logged about the activity of the
application while it runs. You may be asked to enable this setting to
help the developers fix a bug you have reported.
